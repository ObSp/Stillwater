...
function perlin:noise(x, y, z)
    ...
    local xi = b32Band(math.floor(x),255)
    local yi = b32Band(math.floor(y),255)
    local zi = b32Band(math.floor(z),255)
...
function perlin:grad(hash, x, y, z)
    return self.dot_product[b32Band(hash,0xF)](x,y,z)
end
